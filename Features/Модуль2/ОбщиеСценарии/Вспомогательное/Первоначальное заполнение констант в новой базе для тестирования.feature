...
Функционал: Первоначальное заполнение констант в новой базе для тестирования
...
@Описание: заполнение констант для новой базы
@ПримерИспользования: И заполнение констант для новой базы
Сценарий: заполнение констант для новой базы
